...
for (gs in c("ONSincid")) { ## just one column
...
plot1 = plot(allz$date[r2u], allz[[varn]][r2u], ylab="", xlab="", type="l", col=1,  cex.axis=1.0, ylim = yyll)
par(new = TRUE)
...
mtext("Month in 2021-2022", side=1, line=1.5, cex=1.1)
mtext("Daily count of new P12 cases", side = 2, line = 1.5,cex=1.1 )
mtext("Daily estimate from ONS", side=4, line = 1.5, cex=1.1)
